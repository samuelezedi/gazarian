                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-three__left">
                            ...
                            <p style="margin-bottom: 15px;">But amidst the darkness, there was also light. Amidst the despair, 
                            ...
                            <p style="margin-bottom: 15px;">As I grew older, the memories of my childhood haunted me, driving me to action. 
                            ...
                            I founded an NGO dedicated to helping the victims of war, providing aid and assistance to those caught in the crossfire of conflict. Our mission was simple yet profound: to heal the wounds of war, both physical and emotional, and to rebuild shattered lives from the ground up.
                            </p>
                            <p style="margin-bottom: 20px;">
                            Through our efforts, we provided medical care to the injured, education to the orphaned, and livelihood opportunities to the displaced. We worked tirelessly, fueled by the belief that no one should have to endure the horrors of war alone.
                            </p>
                            <!-- <a href="about.html" class="thm-btn about-three__btn">Learn More</a> -->
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="about-four__left">
                            <div class="about-four__img-box">
                                <div class="about-four__img">
                                    <img src="./assets/new/children2.png" alt="">
                                </div>
